...
from .g1_mimic_future_config_cjm import G1MimicStuFutureCJMCfg
...
class G1MimicFutureCJM(G1MimicDistill):
    ...
    def __init__(self, cfg: G1MimicStuFutureCJMCfg, sim_params, physics_engine, sim_device, headless):
